...
public interface ServiceReviewRepository
        extends JpaRepository<ServiceReview, Long> {
    ...
    Optional<ServiceReview> findByServiceOrder_ServiceOrderIdAndUser_IdUserAndDeletedAtIsNull(Long serviceOrderId,String idUser);
